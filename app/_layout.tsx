...
import ModalHeadrText from '@/components/ModalHeadrText';
  ...
  return (
      <Stack>
        ...
        <Stack.Screen name="(modals)/login" 
                      options={{
                        title:'Login or Sign Up', headerTitleStyle:{fontFamily:'mon-sb'},
                        presentation:'modal', 
                        headerLeft:() => ( 
        ...
        <Stack.Screen name='(modals)/booking' 
                      options={{
                        ...
                        headerTitle:()=> <ModalHeadrText/>,headerBackVisible:false,
                        headerLeft:() => ( 
                        <TouchableOpacity style={{backgroundColor:'#fff',padding:4, borderColor:Colors.grey,borderRadius:20,borderWidth:1}} onPress={() => router.back()} >
